    ...
    .then(function () {
      return Promise.all([
        ...
        knex('organization').insert({
          ...
          address: '1490 Lafayette Street Suite 101, Denver, CO 80218',
          contact: 'Brett Heyl',
        ...
        knex('organization').insert({
          ...
          address: '15200 CLINTON ST, BRIGHTON, CO 80602',
        ...
        knex('organization').insert({
          ...
          address: '1860 Lincoln Street, Suite 605, Denver, Colorado 80203',
        ...
        knex('organization').insert({
          ...
          address: 'PO Box 1961, Grand Junction, CO 81502',
